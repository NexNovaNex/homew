...
export const metadata: Metadata = {
  title: "Smoke Smell Removing Device",
  description: "Transform your car from 'smoker's vehicle' to fresh and clean in just 24 hours — guaranteed or your money back.",
  icons: {
    icon: [
      {
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className={`${inter.className} bg-black bg-dotted-grid`}>
        ...
        <noscript>
          <img height="1" width="1" style={{display: 'none'}} src="https://www.facebook.com/tr?id=620448270987291&ev=PageView&noscript=1" />
        </noscript>
